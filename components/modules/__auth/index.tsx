...
import CoinBaseVector from "../__modules__/_vectors/coinbaseVector";
import CrossVector from "../__modules__/_vectors/crossVector";
import MetaMaskVector from "../__modules__/_vectors/metamaskVector";
import TrustWalletVector from "../__modules__/_vectors/trustWalletVector";
import WalletConnectVector from "../__modules__/_vectors/walletconnectVector";
  ...
  return (
    <div>
      <div className="text-center">
        <p className="text-xl font-medium">Choose Your Wallet</p>
      </div>
