  ...
  return (
    <div className="relative">
      <div className="relative">
        ...
        />
        <p className="absolute top-0 text-white px-5 py-5 text-3xl font-IBEM_Plex_Sans transition-all ease-in-out duration-500 bg-black bg-opacity-40 w-full rounded-t-2xl">
