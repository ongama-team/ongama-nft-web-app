      ...
      {staticImages.map((staticImage, index) => {
        return (
          ...
          >
            ...
            <p className="absolute top-0 text-white px-5 py-5 text-sm w-full font-ibemPlexSans transition-all ease-in-out duration-500 bg-black bg-opacity-40 w-full rounded-t-2xl">
              {staticImage.name}
            </p>
          </div>
        );
